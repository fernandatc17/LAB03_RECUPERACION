...
import com.ticlavilca.abigail.poketinder.databinding.FragmentFavoriteBinding
import com.ticlavilca.abigail.poketinder.ui.adapter.MyPokemonsAdapater
import com.ticlavilca.abigail.poketinder.ui.viewmodel.FavoriteViewModel
...
class FavoriteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        favoriteViewModel.myPokemonList.observe(viewLifecycleOwner) {
            listMyPokemon.clear() // Limpia la lista antes de agregar nuevos elementos
